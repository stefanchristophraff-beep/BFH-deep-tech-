...
const FAQ_DE = [
  ...
  },
  {
    ...
    a: "Die Programme werden im Support Navigator anhand der Technology Readiness Levels (TRL) und Market Readiness Levels (MRL) strukturiert. Dies ermöglicht eine präzise Zuordnung zu den drei Phasen der Venture-Journey:\n\nEarly Stage (TRL/MRL 1–3): Ideenfindung und Proof-of-Concept.\nMid Stage (TRL/MRL 4–6): Validierung und Prototyping.\nLater Stage (TRL/MRL 7–9): Markteintritt und Skalierung.",
  },
  {
...
const FAQ_EN = [
  ...
  },
  {
    ...
    a: "The programs in the Support Navigator are structured according to Technology Readiness Levels (TRL) and Market Readiness Levels (MRL). This enables a precise assignment to the three phases of the venture journey:\n\nEarly Stage (TRL/MRL 1–3): Idea development and proof of concept.\nMid Stage (TRL/MRL 4–6): Validation and prototyping.\nLater Stage (TRL/MRL 7–9): Market entry and scaling.",
  },
  {
