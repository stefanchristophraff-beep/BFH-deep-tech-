...
const OFFERINGS_DE: Record<string, string> = {
  ...
  "Network & Ecosystem": "Zugang zu Netzwerken aus Investor:innen, Corporates, Alumni, Hochschulen und anderen Startups.",
...
const OFFERINGS_EN: Record<string, string> = {
  ...
  "Network & Ecosystem": "Access to networks of investors, corporates, alumni, universities and other startups.",
