      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-6 text-sm" style={{ color: "var(--bfh-body)" }}>
          ...
          <section>
            ...
            <p>Der Deep-Tech Support Navigator wurde im Rahmen einer Masterthesis an der Berner Fachhochschule entwickelt, in Zusammenarbeit mit Innosuisse – Schweizerische Agentur für Innovationsförderung.</p>
          </section>
