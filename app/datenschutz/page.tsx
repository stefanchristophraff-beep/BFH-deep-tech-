      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-6 text-sm" style={{ color: "var(--bfh-body)" }}>
          ...
          <section>
            ...
            <p className="mt-2">Diese Daten werden ausschliesslich zur Bearbeitung Ihres Feedbacks und zur Weiterentwicklung des Deep-Tech Support Navigators verwendet.</p>
          </section>
